...
pub struct PodIterator<'a, C: BasicTypePod, E: SizedPod> {
    container: &'a C,
    first_element_ptr: *const E,
    current_element_ptr: *const E,
}

impl<'a, C: BasicTypePod, E: SizedPod> PodIterator<'a, C, E> {
    const ALIGN: usize = 8;
...
impl<'a, C: BasicTypePod, E: SizedPod + 'a> Iterator for PodIterator<'a, C, E> {
    type Item = &'a E;
...
impl<'a, C: BasicTypePod, E: SizedPod + 'a> Debug for PodIterator<'_, C, E> {
